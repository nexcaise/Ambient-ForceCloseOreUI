...
- Go to the [Releases page](https://github.com/NexCaise/Ambient-ForceCloseOreUI/releases) to download the latest `.so` file.

#### 2. Installation

- **If you are using [Ambient](https://ambient.kitsuri.dev):**
